const dayten = require('./day10-part2')

test('day 10 part 2', () => {
  expect(dayten(`position=< 9,  1> velocity=< 0,  2>
...
position=<-3,  6> velocity=< 2, -1>`)).toBe(3)

  console.log(dayten(`position=<-10810,  43870> velocity=< 1, -4>
