const dayseven = require('./day7-part1')

test('day 7 part 1', () => {
  expect(dayseven(`Step C must be finished before step A can begin.
...
Step F must be finished before step E can begin.`)).toBe('CABDFE')
  ...
  console.log(dayseven(`Step T must be finished before step P can begin.
