const dayseven = require('./day7-part2')

test('day 7 part 2', () => {
  expect(dayseven(2, 0, `Step C must be finished before step A can begin.
Step C must be finished before step F can begin.
Step A must be finished before step B can begin.
Step A must be finished before step D can begin.
Step B must be finished before step E can begin.
Step D must be finished before step E can begin.
Step F must be finished before step E can begin.`)).toBe(15)

  console.log(dayseven(5, 60, `Step T must be finished before step P can begin.
